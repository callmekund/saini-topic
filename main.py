...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/call_me_kund")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/call_me_kund"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/call_me_kund")],
    ]
)
